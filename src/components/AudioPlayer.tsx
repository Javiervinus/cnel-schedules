...
export default function CustomAudioPlayer({ url }: CustomAudioPlayerProps) {
  ...
  return (
    <>
      <div className="flex flex-row md:fixed md:bottom-12  md:right-10 w-full md:w-auto justify-center items-center  rounded-xl min-h-[2.5rem]  bg-[#171717] text-white mb-3 gap-0  sticky top-[3.75rem] md:top-auto">
